                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                data.forEach(element => {
                                    ...
                                    str += '<div class="col-sm-3"><div class="card mb-3"><a href="'+element.url+'" class="card-title" style="color: #ffffff;" target="_blank"><img src="'+element.url_pic+'" class="card-img-top"><div class="card-img-overlay">'+icon+' '+element.user_name+'</div></a></div></div>';
                                });
